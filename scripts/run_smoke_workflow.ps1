...
python -m mapt_zero_shot.cli score-heuristic --annotations data/processed/mapt_all_missense_variants.tsv --out results/scores/mapt_heuristic_scores.tsv
...
if (Test-Path data/raw/variant_summary.txt.gz) {
    ...
    python -m mapt_zero_shot.cli evaluate --scores results/scores/mapt_heuristic_scores.tsv --labels data/processed/mapt_clinvar_benchmark.tsv --score-column heuristic_score --out results/mapt_heuristic_metrics.tsv
    ...
    python -m mapt_zero_shot.cli compare-models --labels data/processed/mapt_clinvar_benchmark.tsv --model esm2_t6_8M:results/scores/mapt_esm2_t6_8M_scores.tsv:pathogenic_score --model tau_heuristic_v1:results/scores/mapt_heuristic_scores.tsv:heuristic_score --out results/mapt_model_comparison.tsv
    ...
    python -m mapt_zero_shot.cli summarize-domains --scores results/scores/mapt_heuristic_scores.tsv --annotations data/processed/mapt_all_missense_variants.tsv --score-column heuristic_score --out results/mapt_heuristic_domain_summary.tsv
